...
if (isset($_POST['submit'])) {
    ...
    if (empty($first_name_err) && empty($last_name_err) && empty($position_err) && empty($salary_err)) {
        ...
        try {
            $sql = "UPDATE employees SET first_name = :a, last_name = :b, gender = :c, hobbies = :d, position_id = :e, salary = :f WHERE id = :id";
                ...
                <form action="<?= $_SERVER['PHP_SELF'] ?>" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" id="male" value="male" <?= $gender == 'male' ? 'checked' : null ?>>
